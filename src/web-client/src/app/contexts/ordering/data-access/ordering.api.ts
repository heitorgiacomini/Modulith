...
} from '../../../core/graphql/graphql-query-builder.service';
import { CreateOrderRequest, GraphqlResponse, OrderListItem, PaginatedResult } from './ordering.models';
import { AUTHORIZATION_PERMISSION } from '../../../core/auth/authorization-context';
...
export class OrderingService {
  ...
  private readonly readOwnContext = new HttpContext().set(AUTHORIZATION_PERMISSION, {
    resource: 'Orders',
    scopes: ['orders:read-own']
  });
  private readonly createOwnContext = new HttpContext().set(AUTHORIZATION_PERMISSION, {
    resource: 'Orders',
