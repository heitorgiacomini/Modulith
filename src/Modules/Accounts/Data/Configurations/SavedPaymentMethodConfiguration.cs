...
public sealed class SavedPaymentMethodConfiguration : IEntityTypeConfiguration<SavedPaymentMethod>
{
  public void Configure(EntityTypeBuilder<SavedPaymentMethod> builder)
  {
    ...
    builder.Property(paymentMethod => paymentMethod.TenantId).IsRequired();
    ...
    builder.HasIndex(paymentMethod => new { paymentMethod.TenantId, paymentMethod.CustomerAccountId, paymentMethod.Label });
  }
}
